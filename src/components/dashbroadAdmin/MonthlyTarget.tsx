...
export default function MonthlyTarget() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-gray-100 custom-dark:border-gray-800 custom-dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 custom-dark:bg-gray-900 sm:px-6 sm:pt-6">
        ...
        <div className="relative ">
          ...
          <span className="absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full bg-success-50 px-3 py-1 text-xs font-medium text-success-600 custom-dark:bg-success-500/15 custom-dark:text-success-500">
            +10%
          </span>
        </div>
      ...
      <div className="flex items-center justify-center gap-5 px-6 py-3.5 sm:gap-8 sm:py-5">
        ...
        <div className="w-px bg-gray-200 h-7 custom-dark:bg-gray-800"></div>
