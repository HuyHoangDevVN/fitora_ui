    ...
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 custom-dark:border-gray-800 custom-dark:bg-white/[0.03] sm:px-6">
      <div className="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          <button className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 custom-dark:border-gray-700 custom-dark:bg-gray-800 custom-dark:text-gray-400 custom-dark:hover:bg-white/[0.03] custom-dark:hover:text-gray-200">
            <svg
              className="stroke-current fill-white custom-dark:fill-gray-800"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
      ...
      <div className="max-w-full overflow-x-auto">
        <Table>
          {/* Table Header */}
          <TableHeader className="border-gray-100 custom-dark:border-gray-800 border-y">
            <TableRow>
              <TableCell
                isHeader
                className="py-3 font-medium text-gray-500 text-start text-theme-xs custom-dark:text-gray-400"
              >
                Products
              </TableCell>
              <TableCell
          ...
          <TableBody className="divide-y divide-gray-100 custom-dark:divide-gray-800">
                ...
                <TableCell className="py-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-500 text-theme-xs custom-dark:text-gray-400">
                        {product.variants}
                      </span>
                    </div>
                  </div>
                </TableCell>
                <TableCell className="py-3 text-gray-500 text-theme-sm custom-dark:text-gray-400">
                  {product.price}
                </TableCell>
                <TableCell className="py-3 text-gray-500 text-theme-sm custom-dark:text-gray-400">
                  {product.category}
